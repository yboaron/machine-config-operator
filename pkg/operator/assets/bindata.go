...
// sources:
// manifests/baremetal/chk_ocp_script.sh
...
var _manifestsBaremetalChk_ocp_scriptSh = []byte(`#!/bin/bash 
/usr/bin/curl -o /dev/null -kLfs https://localhost:6443/readyz 
`)

func manifestsBaremetalChk_ocp_scriptShBytes() ([]byte, error) {
	return _manifestsBaremetalChk_ocp_scriptSh, nil
}

func manifestsBaremetalChk_ocp_scriptSh() (*asset, error) {
	bytes, err := manifestsBaremetalChk_ocp_scriptShBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "manifests/baremetal/chk_ocp_script.sh", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
vrrp_script chk_ocp {
    script "/usr/bin/timeout 0.9 /etc/kubernetes/manifests/chk_ocp_script.sh"
    interval 1
    weight 50
}
...
var _bindata = map[string]func() (*asset, error){
	"manifests/baremetal/chk_ocp_script.sh":                                  manifestsBaremetalChk_ocp_scriptSh,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"manifests": &bintree{nil, map[string]*bintree{
		"baremetal": &bintree{nil, map[string]*bintree{
			"chk_ocp_script.sh":     &bintree{manifestsBaremetalChk_ocp_scriptSh, map[string]*bintree{}},
